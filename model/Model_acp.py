...
def Model_acp():
    ...
    output_left = Dropout(rate=0.6150035832545435)(l)
    # output_left=tf.keras.layers.Reshape(-1,1)(output_left)

    # middle model:     BiLSTM
    # input features:   PSSM
    input_middle = tf.keras.Input(shape=(50, 20))  ##pssm
    m = Bidirectional(LSTM(120, return_sequences=False))(input_middle)
    ...
    r = Encoder2(dff=5, num_heads=1, num_layers=6)(input_right)
    ...
    x = Dropout(rate=0.3443147638909986)(x)
