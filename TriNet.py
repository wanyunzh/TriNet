...
if __name__ == '__main__':
    ...
    parser.add_argument('--PSSM_file', '-p', help='path of PSSM/PSSM_file', type=str)
    parser.add_argument('--sequence_file', '-s',help='path of sequence file', type=str)
    parser.add_argument('--output', '-o', default='/output.csv',help='path of Trinet result,defaut with path of current path/output ', type=str)
    parser.add_argument('--operation_mode','-mode',help='c for anticancer prediction and m for antimicrobial prediction',type=str)
